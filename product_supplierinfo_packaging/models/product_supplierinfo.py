...
class ProductSupplierInfo(models.Model):
    ...
    def _inverse_packaging_price(self):
        ...
        for rec in self:
            ...
            skip = (
                not rec.packaging_id
                or float_is_zero(packaging_price, precision_digits=price_digits)
                or float_is_zero(packaging_qty, precision_digits=price_digits)
            )
            if skip:
                continue
