...
class AbcClassificationProfile(models.Model):
    ...
    def _auto_apply_computed_value_for_product_levels(self):
        ...
        self.env["abc.classification.product.level"].browse(level_ids).modified(["manual_level_id"])
        self.env["abc.classification.product.level"].browse(level_ids).recompute()
